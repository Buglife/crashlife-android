...
final class Connectivity {
    ...
    private Connectivity(@Nullable NetworkInfo wifiInfo, @Nullable NetworkInfo mobileInfo, @Nullable String carrierName) {
        mWifiInfo = wifiInfo;
        ...
        Connectivity build() {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                ...
                for (Network network : networks) {
                    @SuppressLint("MissingPermission") NetworkInfo networkInfo = connectivityManager.getNetworkInfo(network);
